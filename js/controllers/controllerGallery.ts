...
class ControllerGallery {
     ...
     * @param gallery
     */
    public galleryNotEmpty(gallery) {
        var res = false;
     ...
     */
    public setCategories(page, reset) {
        var that = this;
