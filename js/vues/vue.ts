...
class Vue
{
  ...
  constructor(controleur: Controleur)
  {
     ...
     */
    private initialiserSideBarButton() {
        var that = this;
     ...
     */
    static initialiserSideBarWidth() {
